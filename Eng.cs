...
namespace Manipulator
{
    ...
    public class Eng: Image
    {
        ...
        public void SetExtent(int w, int h)
        {
            ...
            this.Source = bmp;
            camera.size = new vec2(width/(float)height*camera.size.y, camera.size.y);
        }
        ...
        public void Render(Triangle[] triangles, mat3 rotation, vec3 translation)
        {
            ...
            for (int i = 0; i < triangles.Length; ++i)
            {
                ...
                if ((transformedTriangle.a.z > -camera.near ||
                     transformedTriangle.b.z > -camera.near || //partially behind camera
                     transformedTriangle.c.z > -camera.near))
                {
                    ...
                    if (transformedTriangle.a.z >= -camera.near &&
                        transformedTriangle.b.z >= -camera.near && //ab behind camera
                        transformedTriangle.c.z < -camera.near) //replace a&b
                    {
                        ...
                        var bary_a = GetBarycentricCoordinates(transformedTriangle.a, transformedTriangle.b,
                            transformedTriangle.c, newA);
                        var bary_b = GetBarycentricCoordinates(transformedTriangle.a, transformedTriangle.b,
                            transformedTriangle.c, newB);
                        var newColorA = bary_a.x * transformedTriangle.color_a +
                                        bary_a.y * transformedTriangle.color_b +
                                        bary_a.z * transformedTriangle.color_c;
                        var newColorB = bary_b.x * transformedTriangle.color_a +
                                        bary_b.y * transformedTriangle.color_b +
                                        bary_b.z * transformedTriangle.color_c;
                        var newNormal_a = bary_a.x * transformedTriangle.normal_a +
                                          bary_a.y * transformedTriangle.normal_b +
                                          bary_a.z * transformedTriangle.normal_c;
                        var newNormal_b = bary_b.x * transformedTriangle.normal_a +
                                          bary_b.y * transformedTriangle.normal_b +
                                          bary_b.z * transformedTriangle.normal_c;
                    ...
                    else if (transformedTriangle.a.z >= -camera.near &&
                             transformedTriangle.c.z >= -camera.near && //ac behind camera
                             transformedTriangle.b.z < -camera.near) //replace a&c
                    {
                        ...
                        var bary_a = GetBarycentricCoordinates(transformedTriangle.a, transformedTriangle.b,
                            transformedTriangle.c, newA);
                        var bary_c = GetBarycentricCoordinates(transformedTriangle.a, transformedTriangle.b,
                            transformedTriangle.c, newC);
                        var newColorA = bary_a.x * transformedTriangle.color_a +
                                        bary_a.y * transformedTriangle.color_b +
                                        bary_a.z * transformedTriangle.color_c;
                        var newColorC = bary_c.x * transformedTriangle.color_a +
                                        bary_c.y * transformedTriangle.color_b +
                                        bary_c.z * transformedTriangle.color_c;
                        var newNormal_a = bary_a.x * transformedTriangle.normal_a +
                                          bary_a.y * transformedTriangle.normal_b +
                                          bary_a.z * transformedTriangle.normal_c;
                        var newNormal_c = bary_c.x * transformedTriangle.normal_a +
                                          bary_c.y * transformedTriangle.normal_b +
                                          bary_c.z * transformedTriangle.normal_c;
                        transformedTriangle.color_a = newColorA;
                    ...
                    else if (transformedTriangle.b.z >= -camera.near &&
                             transformedTriangle.c.z >= -camera.near && //bc behind camera
                    ...
                    else
                    {
                        ...
                        {
                            //swap
                            (transformedTriangle.a, transformedTriangle.b, transformedTriangle.c) = (
                                transformedTriangle.b, transformedTriangle.c, transformedTriangle.a);
                            (transformedTriangle.color_a, transformedTriangle.color_b,
                                transformedTriangle.color_c) = (transformedTriangle.color_b,
                                transformedTriangle.color_c, transformedTriangle.color_a);
                            (transformedTriangle.normal_a, transformedTriangle.normal_b,
                                transformedTriangle.normal_c) = (transformedTriangle.normal_b,
                                transformedTriangle.normal_c, transformedTriangle.normal_a);
                        }
                        else if (transformedTriangle.c.z >= -camera.near) //c behind
                        {
                            //swap
                            (transformedTriangle.a, transformedTriangle.b, transformedTriangle.c) = (
                                transformedTriangle.c, transformedTriangle.a, transformedTriangle.b);
                            (transformedTriangle.color_a, transformedTriangle.color_b,
                                transformedTriangle.color_c) = (transformedTriangle.color_c,
                                transformedTriangle.color_a, transformedTriangle.color_b);
                            (transformedTriangle.normal_a, transformedTriangle.normal_b,
                                transformedTriangle.normal_c) = (transformedTriangle.normal_c,
                                transformedTriangle.normal_a, transformedTriangle.normal_b);
                        }

                        vec3 ac_intersection =
                            IntersectionWithCameraPlane(transformedTriangle.a, transformedTriangle.c);
                        vec3 ab_intersection =
                            IntersectionWithCameraPlane(transformedTriangle.a, transformedTriangle.b);

                        vec3 ac_i_barycentric = GetBarycentricCoordinates(transformedTriangle.a,
                            transformedTriangle.b, transformedTriangle.c, ac_intersection);
                        vec3 ab_i_barycentric = GetBarycentricCoordinates(transformedTriangle.a,
                            transformedTriangle.b, transformedTriangle.c, ab_intersection);
                        ...
                        additionalTriangle.color_a = lerp(transformedTriangle.color_a, transformedTriangle.color_b,
                            transformedTriangle.color_c, ac_i_barycentric);
                        additionalTriangle.color_b = lerp(transformedTriangle.color_a, transformedTriangle.color_b,
                            transformedTriangle.color_c, ab_i_barycentric);
                        additionalTriangle.color_c = transformedTriangle.color_b;

                        additionalTriangle.normal_a = lerp(transformedTriangle.normal_a,
                            transformedTriangle.normal_b, transformedTriangle.normal_c, ac_i_barycentric);
                        additionalTriangle.normal_b = lerp(transformedTriangle.normal_a,
                            transformedTriangle.normal_b, transformedTriangle.normal_c, ab_i_barycentric);
        ...
        void drawFragment(int x, int y, Triangle triangle, vec3 barycentricCoordinates)
        {
            ...
            if(enableLighting && (triangle.normal_a.x!=0 || triangle.normal_a.y!=0 || triangle.normal_a.z!=0))//lighting
            {
                ...
                //it is not noticeable in most cases with fake normals
                //and redundant when real normals are used (then they face the same direction)
        ...
        public void RenderLine(Line line)
        {
            ...
            if (glm.Abs(ap.x - bp.x) > glm.Abs(ap.y - bp.y))
            {
                ...
                for (int x = startX; x < stopX; ++x)
                {
                    ...
                    if (y >= 0 && y < height)
                    {
                        frameBuffer[(y * width + x) * 4] = 255; //B
                        frameBuffer[(y * width + x) * 4 + 1] = 255; //G
                        frameBuffer[(y * width + x) * 4 + 2] = 255; //R
                        frameBuffer[(y * width + x) * 4 + 3] = 255; //A
                    }
                }
            }
